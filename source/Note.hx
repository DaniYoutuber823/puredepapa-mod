		...
		switch (daStage)
		{
			case 'school' | 'schoolEvil':
				...
				if(burning){
					...
					loadGraphic(Paths.image('NOTE_fire-pixel', "week5"), true, 21, 31);
			...
			default:
				...
				if(burning){
					...
					{
						frames = Paths.getSparrowAtlas('fourth/mech/ALL_deathnotes', "week5");
					...
					{
						frames = Paths.getSparrowAtlas('NOTE_fire', "week5");
