	...
	public function new(x:Float, y:Float, ?character:String = "bf", ?isPlayer:Bool = false)
	{
		...
		switch (curCharacter)
		{
			...
			case 'bf-pixel-corrupted':
				frames = Paths.getSparrowAtlas('characters/bfCorrupted', 'shared');
				animation.addByPrefix('idle', 'BF IDLE', 24, false);
				animation.addByPrefix('singUP', 'BF UP NOTE', 24, false);
				animation.addByPrefix('singLEFT', 'BF LEFT NOTE', 24, false);
				animation.addByPrefix('singRIGHT', 'BF RIGHT NOTE', 24, false);
				...
				addOffset('idle', -87, -36);
				addOffset("singUP", -47, 6);
				addOffset("singRIGHT", -125, -41);
				addOffset("singLEFT", 11, -20);
				addOffset("singDOWN", -101, -85);
				addOffset("singUPmiss", -97, 26);
				addOffset("singRIGHTmiss", -125, -20);
				addOffset("singLEFTmiss", -48, -40);
				addOffset("singDOWNmiss", -62, -79);
				...
				flipX = true;
			case 'carne-pixel-corrupted':
				frames = Paths.getSparrowAtlas('characters/carneCorrupted', 'shared');
				animation.addByPrefix('idle', 'BF IDLE', 24, false);
				animation.addByPrefix('singUP', 'BF UP NOTE', 24, false);
				animation.addByPrefix('singLEFT', 'BF LEFT NOTE', 24, false);
				animation.addByPrefix('singRIGHT', 'BF RIGHT NOTE', 24, false);
