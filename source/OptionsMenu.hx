...
class OptionsMenu extends MusicBeatState
{
	...
	var options:Array<OptionCategory> = [
		...
		new OptionCategory("Appearance", [
			...
			new BigSignOption("Las señales de expurgation y eso enormes xd"),
			new CharacterOption("Change your player skin"),
			new CustomizeCharacter("Change your player skin chu"),
